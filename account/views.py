...
from account.models import SignupCode, EmailConfirmation, Account
...
class SettingsView(LoginRequiredMixin, FormView):
    ...
    def get_initial(self):
        ...
        if self.primary_email_address:
            initial["email"] = self.primary_email_address
        initial["nickname"] = self.request.user.account.nickname
